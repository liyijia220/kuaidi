    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="padding-left: 40px;margin-top: 15px">
          ...
          <div style="margin-bottom: -15px">
            ...
            <a-form-item label="快递单号" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d" style="margin-left: -36px">
              <j-search-select-tag placeholder="输入快递单号" v-decorator="[ 'wasteMaterialCode',validatorRules.wasteMaterialCode]" style="width: 220px" class="inupt_b_a" dict="material,serial,serial" :async="true" >
              </j-search-select-tag>
            </a-form-item>
            <a-form-item label="快递名称" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"style="margin-left: -35px">
              <a-input v-decorator="['wasteMaterialText', validatorRules.wasteMaterialText]" placeholder="请输入快递名称" class="inupt_b_a"></a-input>
            </a-form-item>
            <a-form-item label="体积单位" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"style="margin-left: -35px">
              <a-select v-decorator="['wasteMaterialUnit', validatorRules.wasteMaterialUnit]" placeholder="请选择体积单位" class="inupt_b_a" style="width: 220px" >
        ...
        <div style="margin-bottom: -15px">
          <a-form-item label="目的地" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
            <a-input v-decorator="['projectNo', validatorRules.projectNo]" placeholder="请输入目的地" class="inupt_b_a"></a-input>
          </a-form-item>
          <a-form-item label="当前仓库" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b" style="margin-right: 273px">
...
<!--            </a-select>-->
<!--          </a-form-item>-->
<!--&lt;!&ndash;          <a-form-item label="废旧物料编码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"style="margin-left: -35px">&ndash;&gt;-->
<!--&lt;!&ndash;            <a-input v-decorator="['wasteMaterialCode', validatorRules.wasteMaterialCode]" placeholder="请输入废旧物料编码" class="inupt_b_a"></a-input>&ndash;&gt;-->
...
<!--        </div>-->
        <div style="margin-bottom: -15px">
          <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
            <a-input v-decorator="['rateFormation']" placeholder="备注" class="inupt_b_a"></a-input>
          </a-form-item>
          <a-form-item label="计划完成时间" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d">
            <j-date placeholder="请选择计划完成时间" v-decorator="['plansCompleteTime']" :trigger-change="true" class="inupt_b_a"/>
          </a-form-item>
    ...
    data () {
      return {
        ...
        validatorRules: {
          ...
          wasteMaterialCode: { rules: [{ required: true, message: '请输入快递单号' }] },
          wasteMaterialText: { rules: [{ required: true, message: '请输入快递名称' }] },
          wasteMaterialUnit: { rules: [{ required: true, message: '请选择体积单位' }] },
          numReceipts: { rules: [{ required: true, message: '请输入重量' }] },
          projectNo: { rules: [{ required: true, message: '请输入目的地' }] },
          projectName: { rules: [{ required: true, message: '当前仓库' }] },
          completeState: { rules: [{ required: true, message: '请选择完成状态' }] },
          assetNo: { rules: [{ required: true, message: '请输入 当前库位' }] },
        },
        url: {
          add: "/cable/plan1/add",
