...
<!--<template>-->
<!--  &lt;!&ndash; <div class="indexclass"> &ndash;&gt;-->
...
<!--            <span class="span_title_span">当月出入库统计</span>-->
<!--          </div>-->
...
<!--          <div class="span_title">-->
<!--            <div class="span_title_icon"></div>-->
<!--            <span class="span_title_span"></span>-->
<!--            &lt;!&ndash;<a-select class="span_title_select" size="small" default-value="lucy" style="width: 120px"-->
<!--                      @change="handleChange">-->
...
<!--          <div class="span_title">-->
<!--            <div class="span_title_icon"></div>-->
<!--            <span class="span_title_span">出库统计</span>-->
<!--          </div>-->
<!--          <div class="span_hx"></div>-->
<!--          <div>-->
...
<!--&lt;!&ndash;              &lt;!&ndash; 新品物料统计隐藏模块 &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;              <a-modal&ndash;&gt;-->
<!--&lt;!&ndash;                title="新品物料统计"&ndash;&gt;-->
<!--&lt;!&ndash;                :visible="visible_xptj"&ndash;&gt;-->
<!--&lt;!&ndash;                :confirm-loading="confirmLoading"&ndash;&gt;-->
<!--&lt;!&ndash;                @ok="handleOk"&ndash;&gt;-->
<!--&lt;!&ndash;                @cancel="handleCancel_xptj"&ndash;&gt;-->
<!--&lt;!&ndash;              >&ndash;&gt;-->
<!--&lt;!&ndash;                <a-table :loadin="!xlUpdateData" id="xpmk" bordered :columns="columns_xp" :pagination="false"&ndash;&gt;-->
<!--&lt;!&ndash;                         :data-source="data_colum_xp" :scroll="{ y: 240 }">&ndash;&gt;-->
<!--&lt;!&ndash;                  <template v-slot:action>&ndash;&gt;-->
<!--&lt;!&ndash;                    <a @click="showPModal_xptj" style="color:#22BDA4">查看</a>&ndash;&gt;-->
...
<!--      </a-col>-->
<!--    </a-row>-->
<!--    &lt;!&ndash; 欢迎进入Jeecg物流管理系统首页 &ndash;&gt;-->
<!--  </div>-->
<!--  &lt;!&ndash; </div> &ndash;&gt;-->
<!--  &lt;!&ndash;  <div>&ndash;&gt;-->
<!--  &lt;!&ndash;    &lt;!&ndash; 主页内容-begin &ndash;&gt;&ndash;&gt;-->
<!--  &lt;!&ndash;    <index-chart v-if="indexStyle==1"></index-chart>&ndash;&gt;-->
<!--  &lt;!&ndash;    <index-bdc v-if="indexStyle==2"></index-bdc>&ndash;&gt;-->
<!--  &lt;!&ndash;    <index-task v-if="indexStyle==3"></index-task>&ndash;&gt;-->
<!--  &lt;!&ndash;    <div style="width: 100%;text-align: right;margin-top: 20px">&ndash;&gt;-->
<!--  &lt;!&ndash;      请选择首页样式：&ndash;&gt;-->
...
<!--  &lt;!&ndash;    </div>&ndash;&gt;-->
<!--  &lt;!&ndash;    &lt;!&ndash; 主页内容-END &ndash;&gt;&ndash;&gt;-->
<!--  &lt;!&ndash;  </div>&ndash;&gt;-->
<!--</template>-->
