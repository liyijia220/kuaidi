...
-- Records of material
-- ----------------------------
INSERT INTO `material` VALUES (13, '123457', '羽绒服', '123456789', '222', 3, NULL, '2024-03-22 00:00:00', '2024-03-22 19:15:44', 'admin', 'admin', '333', '1234567891', '山东省菏泽市', '山东省日照市东港区', '3kg', '河北廊坊1号仓', '2号货架', NULL, NULL);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('MyScheduler', 'AMD1711105533389', 1711109618514, 10000);
...
CREATE TABLE `storage_location`  (
  ...
  `backup5` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库位表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of storage_location
-- ----------------------------
INSERT INTO `storage_location` VALUES (3, 1, '2号货架', 5.00, 0.00, '2024-03-22 19:16:56', NULL, 'admin', NULL, NULL, NULL, NULL, NULL, NULL);
