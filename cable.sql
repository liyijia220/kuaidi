...
CREATE TABLE `inventory`  (
  ...
  `backup2` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '（公告内容）',
  `warehouse_id` int(11) NULL DEFAULT NULL COMMENT '仓库id',
  `storage_location_id` int(11) NULL DEFAULT NULL COMMENT '库位id',
...
CREATE TABLE `material`  (
  ...
  `serial` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '快递单号(唯一)',
  ...
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `backup1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件人',
  `backup2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件人手机号',
  `backup3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '始发地',
  `backup4` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '目的地',
...
CREATE TABLE `sys_user`  (
  ...
  `realname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '员工姓名',
  ...
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `user_identity` tinyint(1) NULL DEFAULT NULL COMMENT '身份（）',
...
CREATE TABLE `vehicle`  (
  ...
  `type` int(2) NULL DEFAULT NULL COMMENT '车辆类型(字典)',
...
CREATE TABLE `warehouse`  (
  ...
  `type` int(11) NULL DEFAULT NULL COMMENT '类型(字典..)',
